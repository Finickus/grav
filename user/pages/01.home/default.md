        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <img src="/home/Service04_3.jpg" class="card-img-top" alt="Исправление ошибок" style="height: 200px; object-fit: cover;">
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <img src="/home/service04_1.jpg" class="card-img-top" alt="Диагностика" style="height: 200px; object-fit: cover;">
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <img src="/home/service04_2.jpg" class="card-img-top" alt="Ремонт котлов" style="height: 200px; object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4 text-center">
            <div class="col-md-4">
                <div class="bg-white p-4 rounded shadow-sm h-100">
                    <img class="service-icon" src="/home/arrows_question.svg" alt="Диагностика">
            ...
            <div class="col-md-4">
                <div class="bg-white p-4 rounded shadow-sm h-100">
                    <img class="service-icon" src="/home/basic_settings.svg" alt="Ремонт">
            ...
            <div class="col-md-4">
                <div class="bg-white p-4 rounded shadow-sm h-100">
                    <img class="service-icon" src="/home/basic_message_multiple.svg" alt="Консультации">
        ...
        <div class="card shadow border-0 overflow-hidden">
            <div class="row g-0 align-items-center">
                <div class="col-lg-5 text-center bg-light">
                    <img src="/home/avtoS04.jpg" alt="Сервис на выезде" class="img-fluid" style="max-height: 400px; object-fit: cover;">
                </div>
...
<section class="py-5">
    <div class="container">
        <div class="row align-items-center g-4">
            <div class="col-md-4">
                <img src="/home/Screenshot_35.jpg" class="img-fluid rounded shadow" alt="Сервисный центр">
            </div>
            <div class="col-md-8">
