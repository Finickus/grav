---
title: 'Ремонт котлов Navien в Москве и Московской области'
---
...
<div class="container my-5">
    <div class="row align-items-center">
        <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <p class="lead">Профессиональный ремонт газовых котлов <strong>Navien (Навьен)</strong> в Москве и Московской области. Гарантия качества, оригинальные запчасти, выезд в день обращения.</p>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="text-center">
                    ...
                    <p>Устраняем неисправности за 1 визит. Наши специалисты имеют большой опыт работы с котлами Navien всех моделей.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-center">
        ...
        <div class="col-lg-10">
            <div class="accordion shadow-sm" id="errorCodesAccordion">
                <div class="accordion-item">
                    ...
                    <div id="collapse01" class="accordion-collapse collapse show" aria-labelledby="heading01" data-bs-parent="#errorCodesAccordion">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse02" class="accordion-collapse collapse" aria-labelledby="heading02" data-bs-parent="#errorCodesAccordion">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse03" class="accordion-collapse collapse" aria-labelledby="heading03" data-bs-parent="#errorCodesAccordion">
                        <div class="accordion-body">
                            <p><strong>Причины:</strong> Неисправность вентилятора, засорение дымохода, проблемы с датчиком тяги (прессостатом).</p>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse10" class="accordion-collapse collapse" aria-labelledby="heading10" data-bs-parent="#errorCodesAccordion">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse12" class="accordion-collapse collapse" aria-labelledby="heading12" data-bs-parent="#errorCodesAccordion">
                        <div class="accordion-body">
                            <p><strong>Причины:</strong> Недостаточное давление газа, проблемы с дымоудалением, загрязнение электродов.</p>
                            <p><strong>Решение:</strong> Проверить давление газа, очистить дымоход и электроды, проверить систему подачи воздуха.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse13" class="accordion-collapse collapse" aria-labelledby="heading13" data-bs-parent="#errorCodesAccordion">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse15" class="accordion-collapse collapse" aria-labelledby="heading15" data-bs-parent="#errorCodesAccordion">
                        <div class="accordion-body">
                            <p><strong>Причины:</strong> Неисправность датчика температуры ГВС, обрыв или замыкание в цепи датчика.</p>
                            <p><strong>Решение:</strong> Проверить контакты датчика, при необходимости заменить датчик температуры.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse16" class="accordion-collapse collapse" aria-labelledby="heading16" data-bs-parent="#errorCodesAccordion">
                        <div class="accordion-body">
                            <p><strong>Причины:</strong> Неисправность датчика температуры отопления, обрыв или замыкание в цепи датчика.</p>
                            <p><strong>Решение:</strong> Проверить контакты датчика, при необходимости заменить датчик температуры.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                ...
                <p class="lead mb-4">Обратитесь к нам прямо сейчас! Наши специалисты с многолетним опытом готовы помочь вам устранить любые неисправности котлов Navien.</p>
