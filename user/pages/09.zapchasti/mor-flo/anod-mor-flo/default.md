...
<div class="container py-5">
    <div class="p-5 mb-5 rounded-3 shadow-lg bg-custom-dark text-white text-center">
        ...
        <p class="lead">Для American Water Heater, Mor-Flo G61, G62</p>
        <p class="fs-4 fw-bold mt-3 text-accent-red">Длина 1000 мм</p>
    ...
    <div class="text-center mb-5">
        <a href="https://service04.ru/bl-content/uploads/pages/f254d8bcceca60182eaa1ed35ff64cd0/morflo_499.jpg" class="lightbox-trigger d-inline-block" data-bs-toggle="modal" data-bs-target="#modal-anode-img">
            <img src="https://service04.ru/bl-content/uploads/pages/f254d8bcceca60182eaa1ed35ff64cd0/morflo_499.jpg" alt="Магниевый анод" class="img-fluid rounded shadow-lg border border-info" style="max-height: 400px;">
        </a>
    </div>
    ...
    <div class="card mb-5 border-info shadow-sm">
        ...
        <div class="card-body small">
            <p>Анод магниевый G61/G62 нейтрализует воду, собирая примеси и предотвращая образование накипи. Изготовлен из магния и алюминия, обеспечивает надёжную защиту бойлера и продлевает срок его службы.</p>
    ...
    <p class="lead small mb-5">Анод защищает внутренние стенки бойлера от накипи и коррозии, обеспечивая долгосрочную и безопасную работу устройства.</p>
    ...
    <div id="buy" class="card p-4 bg-primary text-white text-center shadow-lg">
        <div class="card-body">
    ...
    <div class="modal fade" id="modal-anode-img" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content modal-content-lightbox">
                ...
                <div class="modal-body p-0 text-center"><img src="https://service04.ru/bl-content/uploads/pages/f254d8bcceca60182eaa1ed35ff64cd0/morflo_499.jpg" class="img-fluid rounded" alt="Магниевый анод Mor-Flo" style="max-height: 90vh;"></div>
            </div>
        </div>
    </div>
