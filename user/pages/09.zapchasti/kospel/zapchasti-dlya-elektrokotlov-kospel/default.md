...
<div class="container my-5">
    <header class="bg-primary text-white rounded-3 p-4 p-md-5 mb-5 shadow-lg text-center">
        ...
        <p class="lead opacity-75">Оптимальная стоимость оригинальных деталей</p>
    </header>
        ...
        <div class="card-body p-4 p-md-5">
            <div class="row align-items-center">
                <div class="col-lg-6 text-center mb-4 mb-lg-0">
                    <img src="https://service04.ru/bl-content/img/2019/12/EKCO_service04.ru_.jpg" alt="Kospel EKCO" class="img-fluid rounded shadow-sm">
                </div>
                <div class="col-lg-6">
                    <h3 class="h4 fw-bold text-primary mb-3">Оригинальные детали от польского производителя</h3>
                    <p class="text-muted">Электрические котлы «Kospel» – это самый экономичный вариант для отопления жилых помещений и систем ГВС.</p>
                    <p class="text-muted mb-0">Качественные оригинальные запчасти повышают КПД оборудования и значительно сокращают расходы на обслуживание в долгосрочной перспективе.</p>
                </div>
            </div>
            <div class="alert alert-success mt-4 text-center border-0 shadow-sm">
    ...
    <div class="card border-0 shadow-sm mb-5 overflow-hidden">
        ...
        <div class="card-body p-4 p-md-5">
            <p class="mb-4">Мы предлагаем оригинальные комплектующие для всех модификаций польских котлов:</p>
            <div class="row g-4">
                <div class="col-md-6">
            ...
            <div class="alert alert-warning mt-5 border-0 shadow-sm">
                <p class="small mb-0"><i class="fas fa-exclamation-circle me-2"></i>Все детали в каталоге рекомендованы заводом-изготовителем. Это гарантирует 100% совместимость.</p>
            </div>
            <div class="alert alert-light border-start border-4 border-info mt-3 shadow-sm">
                <p class="small mb-0 fw-bold"><i class="fas fa-star text-warning me-2"></i>Если вы не нашли нужную деталь — свяжитесь с нами для индивидуального заказа!</p>
            </div>
        </div>
    </div>

    <div class="card border-0 shadow-sm mb-5 p-4 p-md-5 bg-white">
        <div class="bg-warning text-dark rounded p-3 mb-5 shadow-sm text-center fw-bold text-uppercase">
        ...
        <div class="row g-4 text-center mb-4">
            <div class="col-md-6"><img src="https://service04.ru/bl-content/img/2019/12/kospel-4-1.png" alt="ZM46" class="img-fluid border p-2 rounded" style="max-height: 200px;"></div>
            <div class="col-md-6"><img src="https://service04.ru/bl-content/img/2019/12/kospel-2.png" alt="Kospel Unit" class="img-fluid border p-2 rounded" style="max-height: 200px;"></div>
        </div>
        ...
        <div class="row g-4 text-center mb-4">
            <div class="col-md-6"><img src="https://service04.ru/bl-content/img/2019/12/kospel-3.png" alt="Панель" class="img-fluid border p-2 rounded" style="max-height: 200px;"></div>
            <div class="col-md-6"><img src="https://service04.ru/bl-content/img/2019/12/kospel-4.png" alt="Плата" class="img-fluid border p-2 rounded" style="max-height: 200px;"></div>
        </div>
        <div class="table-responsive mb-5">
            <table class="table table-striped table-hover table-bordered small align-middle">
                <thead class="table-dark">
        ...
        <div class="text-center mb-4">
            <img src="https://service04.ru/bl-content/img/2019/12/kospel-6.png" class="img-fluid border p-3 rounded" style="max-height: 250px;">
        </div>
        <div class="table-responsive mb-5">
        ...
        <div class="row g-4 text-center mb-4">
            <div class="col-md-6"><img src="https://service04.ru/bl-content/img/2019/12/kospel-7.png" class="img-fluid border p-2 rounded" style="max-height: 180px;"></div>
            <div class="col-md-6"><img src="https://service04.ru/bl-content/img/2019/12/kospel-8.png" class="img-fluid border p-2 rounded" style="max-height: 180px;"></div>
        </div>
    ...
    <div class="card border-0 shadow-lg text-center bg-light p-4 p-md-5">
        <h4 class="h3 fw-bold text-primary mb-3"><i class="fas fa-thumbs-up me-2 text-success"></i>Оригинал Kospel по доступным ценам</h4>
        <p class="lead text-muted mb-4">Подбор запчастей по артикулу, скидки мастерам и гарантия на всё оборудование.</p>
...
<style>
    /* Плавный эффект для таблиц */
    .table thead th { vertical-align: middle; }
    .img-fluid:hover { transform: scale(1.05); transition: 0.3s; }
</style>