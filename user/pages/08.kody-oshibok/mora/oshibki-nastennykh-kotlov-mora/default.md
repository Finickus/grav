            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-4">
                    <div class="col-md-5 text-center">
                        <img src="https://service04.ru/bl-content/img/2019/12/1.jpg" alt="Ошибка E0" class="img-fluid rounded shadow-sm border">
                    </div>
                    <div class="col-md-7">
        ...
        <div class="card shadow border-0 mb-4 overflow-hidden">
            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-4 text-center text-md-start">
                    <div class="col-md-5">
                        <img src="https://service04.ru/bl-content/img/2019/12/2.jpg" alt="Ошибка E1" class="img-fluid rounded shadow-sm border">
                    </div>
                    <div class="col-md-7">
    ...
    <div id="error-e2" class="error-section d-none">
        <div class="card shadow border-0 mb-4 overflow-hidden text-center text-md-start">
            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-4">
                    <div class="col-md-5 text-center">
                        <img src="https://service04.ru/bl-content/img/2019/12/3.jpg" alt="Ошибка E2" class="img-fluid rounded shadow-sm border">
                    </div>
                    <div class="col-md-7">
        ...
        <div class="card shadow border-0 mb-4">
            ...
            <div class="card-body p-4">
                <div class="row g-4 align-items-center mb-4">
                    <div class="col-md-4"><img src="https://service04.ru/bl-content/img/2019/12/7.jpg" class="img-fluid rounded border shadow-sm"></div>
                    <div class="col-md-8">
                ...
                <div class="accordion border rounded overflow-hidden shadow-sm">
                    <details class="p-3 border-bottom bg-white">
                        ...
                        <div class="mt-3 small px-3">
                            ...
                            <img src="https://service04.ru/bl-content/img/2019/12/8.jpg" class="img-fluid rounded mt-2 border" style="max-height: 200px;">
                        </div>
                    </details>
                    <details class="p-3 bg-white">
                        ...
                        <div class="mt-3 small px-3">
                            ...
                            <img src="https://service04.ru/bl-content/img/2019/12/9.jpg" class="img-fluid rounded mt-2 border" style="max-height: 200px;">
                        </div>
                    </details>
                </div>
            </div>
        ...
        <div class="card shadow border-0 mb-4 border-start border-success border-5">
            <div class="card-body p-4 p-md-5">
                <div class="row g-4 align-items-center">
                    <div class="col-md-5">
                        <img src="https://service04.ru/bl-content/img/2019/12/10.jpg" alt="ТО" class="img-fluid rounded shadow-sm border">
                    </div>
                    <div class="col-md-7">
