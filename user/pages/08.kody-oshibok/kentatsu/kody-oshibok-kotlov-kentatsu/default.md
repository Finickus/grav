...
metadata:
  description: Коды ошибок котлов Kentatsu Диагностика и устранение неисправностей
    газовых котлов Кентатсу Газовые котлы Kentatsu (Кентатсу) – надежное отопительное...
  og:type: article
  og:title: Коды ошибок котлов Kentatsu - Service04
  og:description: Коды ошибок котлов Kentatsu Диагностика и устранение неисправностей
    газовых котлов Кентатсу Газовые котлы Kentatsu (Кентатсу) – надежное отопительное...
  og:url: https://service04.ru/kody-oshibok/kentatsu/kody-oshibok-kotlov-kentatsu
  og:site_name: Service04
  og:locale: ru_RU
  og:image: https://service04.ru/images/og-default.jpg
  og:image:width: '1200'
  og:image:height: '630'
  canonical: https://service04.ru/kody-oshibok/kentatsu/kody-oshibok-kotlov-kentatsu
  robots: index, follow
  yandex-verification: ''
  geo.region: RU-MOW
