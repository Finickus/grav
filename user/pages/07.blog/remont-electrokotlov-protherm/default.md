...
<div class="col-md-3">
<h4>Монтаж и пусконаладка<span style="font-size: 16px; color: #111111;  background-color: rgba(255, 255, 255, 0.7);"> </span></h4>
...
<h4><span style="background-color: rgba(255, 255, 255, 0.7); color: #111111; ">Сервисное обслуживание котлов: почему это важно и как это сделать</span></h4>
</div>
<div>
...
<p style="padding: 0px; margin: 12px 0px 0px; user-select: text; word-break: break-word; line-height: var(--cib-type-body2-line-height); font-variation-settings: var(--cib-type-body2-font-variation-settings); color: #111111;  background-color: rgba(255, 255, 255, 0.7);">Гарантируем вам:</p>
<ul style="margin: 12px 0px 0px; display: flex; flex-direction: col; gap: 10px; padding-inline-start: 24px; color: #111111;  background-color: rgba(255, 255, 255, 0.7);">
