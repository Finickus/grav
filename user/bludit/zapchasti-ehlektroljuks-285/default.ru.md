---
title: 'Запчасти для газовой колонки Electrolux 285'
---
...
<p class="h5 lead">Найдите и купите все необходимые комплектующие для вашей колонки Electrolux 285</p>
</div>
</div>
</section>
<!-- Введение -->
...
<p class="fs-5 mb-3">Текущий теплообменник, порванный уплотнитель, неисправный блок управления или вышедший из строя микровыключатель больше не станут причиной долгого простоя колонки.</p>
<p>Позвоните в наш центр «Сервис 04», и вы подберёте все необходимые запчасти и комплектующие для газовой колонки Electrolux 285 по наличию и под вашу модель.</p>
<p class="notification is-info mt-3"><strong>Сообщите оператору модель газовой колонки и название детали — вам предложат варианты запчастей для Electrolux 285 по одной из лучших цен в Москве.</strong></p>
...
<p class="card-h3 text-dark"><i class="fas fa-tools me-2"></i> Запчасти Electrolux, наиболее часто подлежащие замене</p>
</header>
<div class="card-body">
...
<td>Горелка (сопло из нержавеющей стали, работа на природном газе).</td>
</tr>
<tr>
...
<p class="card-h3 text-white"><i class="fas fa-exclamation-circle me-2"></i> Устранение неисправностей</p>
</header>
<div class="card-body">
<div class="table-container">
...
<tbody>
<tr>
<td rowspan="3">Нет розжига горелки</td>
<td>Отсутствует подача газа</td>
<td>Откройте кран подвода газа к водонагревателю.</td>
</tr>
<tr>
<td>Отсутствует проток воды</td>
<td>Откройте кран подвода воды к колонке.<br>Откройте кран горячей воды в точке водоразбора.</td>
</tr>
<tr>
<td>Разряжен элемент питания или нарушена полярность установки (модели GWH 285 ERN NanoPro)</td>
<td>Проверьте правильность установки батареи и при необходимости замените элемент питания.</td>
</tr>
<tr>
<td>Низкая температура выходящей воды</td>
<td>Малая подача газа или слишком большой проток воды.</td>
<td>Увеличьте подачу газа, повернув рукоятку газового клапана.<br>Уменьшите проток воды рукояткой водяного клапана.</td>
</tr>
<tr>
<td rowspan="2">Пламя горелки гаснет во время работы</td>
<td>Высокая температура дымовых газов, засорение канала отвода продуктов сгорания.</td>
<td>Проверьте дымоход; при подозрении на засор обратитесь к специализированной организации.</td>
</tr>
<tr>
<td>Недостаточный проток воды</td>
<td>Увеличьте проток воды рукояткой водяного клапана.</td>
</tr>
<tr>
<td>Появление запаха газа</td>
<td>Утечка газа в подводящей магистрали или соединениях.</td>
<td class="bg-danger text-white">Немедленно перекройте подачу газа и обратитесь в аварийную газовую службу.</td>
</tr>
</tbody>
</table>
</div>
...
<p class="h5 lead">Позвоните по телефону <strong class="text-warning">8 (926) 221‑13‑48</strong> или оставьте заявку на сайте.</p>
...
<div class="col-4 mb-2"><a href="https://service04.ru/contact-us/feedback" class="btn btn-info btn-lg w-100"> <i class="fas fa-tools me-2"></i>Вызвать мастера </a></div>
</div>
</div>
</div>
</div>
