...
<p class="h5 lead">Оборудование для безопасности и регулировки процесса горения газа</p>
</div>
</section>
<!-- Основное описание -->
<div class="card mb-5">
...
<div class="message-header"><i class="fas fa-industry me-2"></i>Продукция SIT включает:</div>
<div class="message-body">
<div class="row">
<div class="col">
<ul>
<li><i class="fas fa-fire text-danger me-2"></i> <a href="https://service04.ru/gazovye-klapana" class="has-text-link">Газовые клапана</a></li>
<li><i class="fas fa-microchip text-primary me-2"></i> Автоматику управления</li>
<li><i class="fas fa-bolt text-warning me-2"></i> <a href="https://service04.ru/abc537" class="has-text-link">Электронные блоки розжига</a></li>
<li><i class="fas fa-thermometer-half text-success me-2"></i> Датчики температуры</li>
</ul>
</div>
<div class="col">
<ul>
<li><i class="fas fa-temperature-high text-info me-2"></i> Термогенераторы и термопары</li>
<li><i class="fas fa-fan text-muted me-2"></i> Вентиляторы для отопительной техники</li>
</ul>
</div>
</div>
</div>
...
<h2 class="h4 display-4 mb-0"><i class="fas fa-list me-2"></i>Каталог продукции SIT</h2>
</div>
<div class="table-container">
<table class="table is-bordered is-striped w-100 is-hoverable mt-4">
<thead>
<tr>
<th>Категория</th>
<th>Наименование</th>
...
<h3 class="h4 display-4 mb-0"><i class="fas fa-thumbs-up me-2"></i>Преимущества автоматики SIT</h3>
</div>
<div class="row g-3 text-center mt-4">
<div class="col is-3"><i class="fas fa-shield-alt fa-3x text-primary mb-3"></i>
<h5 class="h5">Безопасность</h5>
<p class="subh6">Оборудование отключает технику в аварийных ситуациях</p>
</div>
<div class="col is-3"><i class="fas fa-cogs fa-3x text-success mb-3"></i>
<h5 class="h5">Точность</h5>
<p class="subh6">Высокоточное устройство, чувствительное к отклонениям</p>
</div>
<div class="col is-3"><i class="fas fa-sync-alt fa-3x text-warning mb-3"></i>
<h5 class="h5">Надежность</h5>
<p class="subh6">Итальянское качество и долговечность</p>
</div>
<div class="col is-3"><i class="fas fa-industry fa-3x text-info mb-3"></i>
<h5 class="h5">Универсальность</h5>
<p class="subh6">Подходит для широкого ряда газовых приборов</p>
</div>
</div>
</div>
<!-- Заказ -->
...
<h3 class="h4 display-4"><i class="fas fa-shopping-cart me-2"></i>Заказать автоматику SIT</h3>
<p class="h5 lead">Оригинальные комплектующие с гарантией</p>
<div class="btn btn-primarys is-centered mt-4"><a href="tel:+79262211348" class="btn btn-light btn-lg"> <i class="fas fa-phone me-2"></i>Позвонить </a> <a href="https://service04.ru/contact-us/feedback" class="btn btn-warning btn-lg text-dark"> <i class="fas fa-envelope me-2"></i>Оставить заявку </a></div>
</div>
</div>
</div>